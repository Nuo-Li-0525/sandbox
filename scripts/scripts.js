...
var modelName = "XYZ"; // Initial model
...
modelButton.addEventListener("click", changeModel); // Uncomment this line after defining the modelButton variable
...
durationButton.addEventListener("click", changeDuration); // Attach changeDuration function to the button
